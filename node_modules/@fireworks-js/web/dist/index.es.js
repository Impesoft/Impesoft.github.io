...
class b {
  ...
  constructor({
    ...
    for (this.x = t, this.y = i, this.ctx = s, this.hue = n, this.gravity = a, this.friction = r, this.flickering = u, this.lineWidth = p, this.explosionLength = l, this.angle = c(0, Math.PI * 2), this.speed = o(1, 10), this.brightness = o(d.min, d.max), this.decay = c(h.min, h.max); this.explosionLength--; )
...
class O {
  ...
  constructor({
    ...
    for (this.x = t, this.y = i, this.sx = t, this.sy = i, this.dx = s, this.dy = n, this.ctx = h, this.hue = a, this.speed = r, this.traceLength = d, this.acceleration = u, this.totalDistance = f(t, i, s, n), this.angle = Math.atan2(n - i, s - t), this.brightness = o(50, 70); this.traceLength--; )
      this.coordinates.push([t, i]);
  }
  update(t) {
...
class z {
  ...
  raf;
  constructor(t, i = {}) {
    this.target = t, this.container = t, this.opts = new S(), this.updateOptions(i), this.createCanvas(this.target), this.sound = new L(this.opts), this.resize = new C(this.opts, this.updateSize.bind(this)), this.mouse = new k(this.opts, this.canvas), this.raf = new E(this.opts, this.render.bind(this));
  }
  get isRunning() {
    return this.running;
  }
...
customElements.define("fireworks-js", M);
export {
  M as Fireworks,
  M as default
};
